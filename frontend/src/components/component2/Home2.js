  ...
  return (
    <div className="section-one d-flex">
      ...
      <div className="para2 text-center p-5">
        <img className="border rounded-circle p-3" src={Img2} alt="loading" />
        <h4>VISA PROCESS</h4>
        <span className="">
          ...
          travel. Ensure all information is truthful and consistent to maximize
          approval chances.{" "}
        </span>
      </div>
      <div className="para3 text-center p-5">
        <img className="border rounded-circle p-3" src={Imag3} alt="loading" />
